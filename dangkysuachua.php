            ...
            <div class="container">
                <div class="rwo">
                    <div class="col-6 offset-md-3">
                        <form id="form_reg" class="bg-light p-4 my-3" action="dksc.php" method="post">
                            <h2 class="py-3 text-center text-uppercase">Đăng ký sửa chữa</h2>
                            ...
                            <div class="form-group">
                                <label for="chitiet">Chú thích</label>
                                <input type="text" name="chitiet" class="form-control" id="chitiet">
                            </div>

                            <input type="submit" class="btn btn-primary btn-block mt-4" name="btn-dksc" value="Đăng ký">
                    </div>
                </div>
        </body>